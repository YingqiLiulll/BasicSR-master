...
from basicsr.data.degradations import random_bivariate_Gaussian,circular_lowpass_kernel, random_mixed_kernels
...
class PretrainV4Dataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(PretrainV4Dataset, self).__init__()
        self.opt = opt
