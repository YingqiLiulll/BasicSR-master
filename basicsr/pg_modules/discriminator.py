...
from basicsr.pg_modules.blocks import DownBlock, DownBlockPatch, conv2d
from basicsr.pg_modules.projector import F_RandomProj
from basicsr.pg_modules.diffaug import DiffAugment
...
class SingleDisc(nn.Module):
    def __init__(self, nc=None, ndf=None, start_sz=256, end_sz=8, head=None, separable=False, patch=False):
        ...
        # 我猜的nfc=number feature channel
        # ndf猜是num descriminator feature
        if ndf is None:
            nfc = channel_dict
        else:
...
class SingleDiscCond(nn.Module):
    def __init__(self, nc=None, ndf=None, start_sz=256, end_sz=8, head=None, separable=False, patch=False, c_dim=1000, cmap_dim=64, embedding_dim=128):
        ...
        channel_dict = {4: 512, 8: 512, 16: 256, 32: 128, 64: 64, 128: 64,
                        256: 32, 512: 16, 1024: 8}
        # channel_dict.keys() dict_keys([4, 8, 16, 32, 64, 128, 256, 512, 1024])
        # channel_dict.values() dict_values([512, 512, 256, 128, 64, 64, 32, 16, 8])
