...
f = os.listdir('C:/Users/13637/Desktop/Set5BIL/LR_degra/blur2_nearest_noise40')
scale = 4

for i in f:
    pf = os.path.join('C:/Users/13637/Desktop/Set5BIL/LR_degra/blur2_nearest_noise40', i)
    ...
    pf3=os.path.join('C:/Users/13637/Desktop/Set5BIL/degra_bil/blur2_nearest_noise40',i)
    # hr.save(pf1)
    # lr.save(pf2)
    bilinear.save(pf3)
