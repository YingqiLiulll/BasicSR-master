...
class classSR_3class_swinir(nn.Module):
    def __init__(self, in_chans=3,):
        super(classSR_3class_swinir, self).__init__()
        self.upscale=4
        self.classifier=Classifier()
        self.net1 = SwinIR(img_size=32, in_chans=in_chans, depths=(6, 6, 6, 6), num_heads=(6, 6, 6, 6),
         embed_dim=60, window_size=2, mlp_ratio=2.,upscale=4, upsampler='pixelshuffledirect', resi_connection='1conv')
        self.net2 = SwinIR(img_size=32, in_chans=in_chans, depths=(6, 6, 6, 6), num_heads=(6, 6, 6, 6),
         embed_dim=60, window_size=4, mlp_ratio=2.,upscale=4, upsampler='pixelshuffledirect', resi_connection='1conv')
