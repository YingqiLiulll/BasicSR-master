...
class PretrainRealESRGANModel(SRGANModel):
    ...
    def __init__(self, opt):
        super(PretrainRealESRGANModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(PretrainRealESRGANModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
