...
class BicubicESRGANModel(SRGANModel):
    ...
    def __init__(self, opt):
        super(BicubicESRGANModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(BicubicESRGANModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
