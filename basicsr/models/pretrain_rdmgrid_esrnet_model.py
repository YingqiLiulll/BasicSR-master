...
class PretrainRdmgridRealESRNetModel(SRModel):
    ...
    def __init__(self, opt):
        super(PretrainRdmgridRealESRNetModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(PretrainRdmgridRealESRNetModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
