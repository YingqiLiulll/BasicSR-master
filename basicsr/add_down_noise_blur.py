...
if __name__ == '__main__':
    ...
    for i in ['Set5','Set14','BSD100','Manga109','Urban100']:
        ...
        GT_folder = '/data0/xtkong/data/benchmark/{}/HR/x4'.format(i)
        save_LR_folder = '/data0/xtkong/data/benchmark/{}/LR_degra'.format(i)
        ...
        for path_GT in img_GT_list:
            ...
            # only downsample
            img_LR = donw_sample_nearest(img_blured)
            save_dir = os.path.join(save_LR_folder, 'blur2_nearest')
            check_dir(save_dir)
            img_LR.save(os.path.join(save_dir,os.path.basename(path_GT)))
            ...
            save_dir = os.path.join(save_LR_folder, 'nearest_noise40')
            check_dir(save_dir)
            ...
            save_dir = os.path.join(save_LR_folder, 'nearest_jepg50')
            check_dir(save_dir)
            img_jepg.save(os.path.join(save_dir,os.path.basename(path_GT)))


            # blur2+nearest+noise40
            # blur
            img_copy = img_GT.copy()
            img_blured = blur_image_v2(img_copy, 2)
            # downsample
            ...
            # noise40
            img_noise = add_noise(40, 40, img_LR)
            save_dir = os.path.join(save_LR_folder, 'blur2_nearest_noise40')
            check_dir(save_dir)
            img_noise.save(os.path.join(save_dir, os.path.basename(path_GT)))

            # blur2+nearest+jepg50
            # blur
            img_copy = img_GT.copy()
            img_blured = blur_image_v2(img_copy, 2)
            # downsample
            ...
            # JEPG50
            img_jepg = convertToJpeg(img_LR, 50)
            save_dir = os.path.join(save_LR_folder, 'blur2_nearest_jepg50')
            check_dir(save_dir)
            img_jepg.save(os.path.join(save_dir, os.path.basename(path_GT)))


            # nearest+noise40+jepg50
            # down
            img_copy = img_GT.copy()
            img_LR = donw_sample_nearest(img_copy)
            # noise
            ...
            save_dir = os.path.join(save_LR_folder, 'nearest_noise40_jepg50')
            check_dir(save_dir)
            img_jepg.save(os.path.join(save_dir, os.path.basename(path_GT)))

            # blur2+nearest+noise40+jepg50
            # blur
            img_copy = img_GT.copy()
            img_blured = blur_image_v2(img_copy, 2)
            # downsample
            ...
            # JEPG50
            img_jepg = convertToJpeg(img_noise, 50)
            save_dir = os.path.join(save_LR_folder, 'blur2_nearest_noise40_jepg50')
            check_dir(save_dir)
            img_jepg.save(os.path.join(save_dir, os.path.basename(path_GT)))
            ...
            # # blur
            # img_copy = img_GT.copy()
            # img_blured = blur_image_v2(img_copy,3)
            # # only downsample
            # img_LR = donw_sample_nearest(img_blured)
            # save_dir = os.path.join(save_LR_folder, 'blur3_nearest')
            # check_dir(save_dir)
            # img_LR.save(os.path.join(save_dir,os.path.basename(path_GT)))
            #
            # # blur3+nearest+noise40
            # # blur
            # img_copy = img_GT.copy()
            # img_blured = blur_image_v2(img_copy, 3)
            # # downsample
            ...
            # # noise40
            # img_noise = add_noise(40, 40, img_LR)
            # save_dir = os.path.join(save_LR_folder, 'blur3_nearest_noise40')
            # check_dir(save_dir)
            # img_noise.save(os.path.join(save_dir, os.path.basename(path_GT)))
            #
            # # blur3+nearest+jepg50
            # # blur
            # img_copy = img_GT.copy()
            # img_blured = blur_image_v2(img_copy, 3)
            # # downsample
            ...
            # # JEPG50
            # img_jepg = convertToJpeg(img_LR, 50)
            # save_dir = os.path.join(save_LR_folder, 'blur3_nearest_jepg50')
            # check_dir(save_dir)
            # img_jepg.save(os.path.join(save_dir, os.path.basename(path_GT)))
            #
            #
            # # blur3+nearest+noise40+jepg50
            # # blur
            # img_copy = img_GT.copy()
            # img_blured = blur_image_v2(img_copy, 3)
            # # downsample
            ...
            # # JEPG50
            # img_jepg = convertToJpeg(img_noise, 50)
            # save_dir = os.path.join(save_LR_folder, 'blur3_nearest_noise40_jepg50')
            # check_dir(save_dir)
            # img_jepg.save(os.path.join(save_dir, os.path.basename(path_GT)))